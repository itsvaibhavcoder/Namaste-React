...
// Restaurants List is JSON data for displaying cards
...
// Restaurant card is component: Image, name, cuisine

const RestaurantCard = ({
  // Destructuring of the props object
    cloudinaryImageId,
    name,
    cuisines,
    area,
...
// Body Component for body section : It contains all restaurants cards
// We are mapping restaurantsList array and passing data to RestaurantCard comonent as props with unique key as index
